  ...
  async function processamentoUseEffect() {
    ...
    if (recarregaTela) {
      ...
      if (obj != undefined) {
        ...
        setLocalAtividade(obj.local_atividade);
        setDataEntrega(obj.data_entrega);
    ...
    if (
      ...
      if (msgDeErro === "") {
        if (novoRegistro) {
          ...
          } else Alert.alert("Falha ao criar atividade!");
        } else {
          console.log("Alterando Atividade...");
          let resposta = await alteraAtividade(objAtividade);
          if (resposta) {
            Alert.alert(
              `Atividade id: ${objAtividade.id} alterada com sucesso!`
            );
            console.log(JSON.stringify(resposta));
          } else
        ...
        console.log(
          "aqui é para executar só depois de ter alterado / inserido a atividade"
        );
        Keyboard.dismiss();
        ...
        <View style={styles.forms}>
          ...
          <View style={styles.switchStatus}>
            ...
            <Switch
              ...
              value={isEnabled}
            />
            <Text style={{ color: `${textoSwitch.cor}` }}>
              {" "}
              {textoSwitch.texto}
            </Text>
          </View>
